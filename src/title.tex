...
\begin{center}
  {
    ...
    {
      \normalsize
      ВЫПУСКНОЙ КВАЛИФИКАЦИОННОЙ РАБОТA 
    } \\[3.25em]
    {
      \normalsize
...
\begin{flushright}
  {
    ...
    \begin{minipage}{.7\textwidth}
      ...
      \hspace{-5pt}$\underset{\text{\scriptsize (Фамилия, И., О.,  ученое звание, степень)}}{\underline{\makebox[\remaining][s]{\strut\hfill Ключев А. О., к.н. доцент\hfill}}}$
      \hfill\signature \\[3em]
